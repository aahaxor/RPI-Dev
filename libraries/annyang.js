...
(function (undefined) {
  ...
  root.annyang = {
    ...
    init: function(commands, resetCommands) {
      ...
      if (repeatingnotices != "release") { //This code was put in by Aaron because the notices were annoying
      recognition.continuous = root.location.protocol === 'http:'; root.console.log("Annyang security notices: %cdefault","color:red");
      } else {
      recognition.continuous = true; root.console.log("Annyang security notices: %coff","color:green");
    }
